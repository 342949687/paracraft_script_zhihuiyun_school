...
function AppEntityPlayerHelper:SetHeadOnDisplay()
    ...
    local school = (System.options.channelId_431 or System.options.isPapaAdventure) and "" or (userinfo.school or "");
    local top = (System.options.channelId_431 or System.options.isPapaAdventure) and -30 or -60
    if (school ~= "") then school = "&lt;" .. school .. "&gt;" end
    local mcml = string.format([[
<pe:mcml>
    <div style="width:200px; margin-left: -100px; margin-top: %dpx; color: %s;">
    ...
    ]], top,color, usertag, playerUsernameStyle, GetUserName(username), school);
