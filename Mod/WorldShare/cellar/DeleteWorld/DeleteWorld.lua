...
function DeleteWorld:GetUrl()
    if System.options.isEducatePlatform then
        return 'script/apps/Aries/Creator/Game/Educate/Project/DeleteWorld.html'
    end
    return 'Mod/WorldShare/cellar/DeleteWorld/Theme/DeleteWorld.xml'
end
