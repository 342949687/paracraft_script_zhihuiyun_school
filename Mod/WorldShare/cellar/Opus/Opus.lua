...
function Opus:ShowCreate(channelId,width,height,x,y,useDesginResolution,zorder)
    Create:ShowCreateEmbedChanel(channelId,width,height,x,y,useDesginResolution,zorder)
end
