...
use the lib:
-------------------------------------------------------
local StyleManager = NPL.load("script/ide/System/UI/Window/StyleManager.lua");
-------------------------------------------------------
]]

local DefaultStyle = NPL.load("./DefaultStyle.lua");
local Style = NPL.load("./Style.lua");
local StyleSheet = NPL.load("./StyleSheet.lua");
