...
use the lib:
-------------------------------------------------------
local Blocks = NPL.load("script/ide/System/UI/Blockly/Blocks/Blocks.lua");
-------------------------------------------------------
]]
NPL.load("(gl)script/ide/System/Windows/mcml/css/StyleColor.lua");
local StyleColor = commonlib.gettable("System.Windows.mcml.css.StyleColor");

local DataBlocks = NPL.load("./Data.lua");
local MathBlocks = NPL.load("./Math.lua");
local VarBlocks = NPL.load("./Var.lua");
local ControlBlocks = NPL.load("./Control.lua");
local EventBlocks = NPL.load("./Event.lua");
local LogBlocks = NPL.load("./Log.lua");
local HelperBlocks = NPL.load("./Helper.lua");


local VueToolbox = NPL.load("./VueToolbox.lua");
local NplToolbox = NPL.load("./NplToolbox.lua");
local BlockToolbox = NPL.load("./BlockToolbox.lua");
local BlockManager = NPL.load("./BlockManager.lua");
