...
ClickResetXmlText = function()
ToolBoxXmlText = DefaultToolBoxXmlText
end

ClickDisabledModeXmlText = function()
...
OnToolBoxCategoryOrderChange = function(category)
...
GetCategoryColorStyle = function(category)
