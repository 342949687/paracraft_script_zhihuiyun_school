...
local MacroBlock = NPL.load("./MacroBlock.lua");
local ListBlock = NPL.load("./ListBlock.lua");
local UIBlock = NPL.load("./UIBlock.lua");
...
function BlockOptionGlobal:ctor()
    ...
    self.__G__ = setmetatable({_G = _G, __ENV = _G}, {__index = _G});
end
