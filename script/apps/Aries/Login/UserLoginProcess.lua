...
-- call this to fix css info bug, such as some hacker injected \0 to the string. 
function UserLoginProcess.ClearAvatarCSS()
	local bOwn, guid = System.Item.ItemManager.IfOwnGSItem(999)
	if(bOwn) then
		echo("UserLoginProcess.ClearAvatarCSS begin")
		System.Item.ItemManager.SetClientData(guid, "", function(msg) 
			echo("UserLoginProcess.ClearAvatarCSS succeed")
		end);
	end
end
...
function UserLoginProcess.Proc_VerifyInventory()
	...
	System.Item.ItemManager.GetItemsInAllBags(nil, function(bSucceed)
		if(bSucceed) then
			...
			-- UserLoginProcess.ClearAvatarCSS()
		else
