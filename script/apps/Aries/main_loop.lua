...
System.options.ZhyChannel = ParaEngine.GetAppCommandLineByParam("zhychannel", "")
System.options.AutoEnterPid = ParaEngine.GetAppCommandLineByParam("auto_enter_pid", nil)
...
System.options.isZhihuiyunSchoolPackage = not System.options.isZhihuiyunDebug
-- System.options.isZhihuiyunSchoolPackage = true
...
local function Aries_load_config(filename)
	...
	-- we will use the same UI for mobile platform, so always IsMobilePlatform is always false since 2018.3.22  
	...
	System.options.IsMobilePlatform = (ParaEngine.GetAppCommandLineByParam("IsMobilePlatform", "false") == "true");
