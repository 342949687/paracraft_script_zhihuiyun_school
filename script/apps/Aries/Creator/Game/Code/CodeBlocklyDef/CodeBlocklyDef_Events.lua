	...
	arg0 = {
		{
			...
			options = {
				...
				{ L"OnEntityEvent", "OnEntityEvent" },
				{ L"OnEntityClick", "OnEntityClick" },
				{ L"OnEntityTick", "OnEntityTick" },
				{ L"OnLoadInEntity", "OnLoadInEntity" },
				{ L"OnUnloadInEntity", "OnUnloadInEntity" },
				{ L"CreateAgentFromEntity", "CreateAgentFromEntity" },
			},
		},
	},
	hide_in_toolbox = true,
