...
function PurchaseMagicBean.PayKeepWork()
	...
	local payurl = string.format([[https://keepwork.com/a/orderConfirm?type=1&payment=rmb&app_name=魔法哈奇&goodsId=984&username=%s&price=%d&user_nid=%s&haqi=1]],oid,price,nid);
